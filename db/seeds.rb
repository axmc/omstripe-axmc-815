...
growth_hacking = Product.create(
	...
	subtitle: "Crash Course", author: "Mattan Griffel", 
 	price: "4.99", sku:"GROHACK1", length: "30 Minutes",
 	author_image_name: "teacher-image.jpg",
    details: "You'll get one streaming Video",
    download_url: "https://s3.amazonaws.com/axmc-one-month-stripe-payments/How+to+add+a+photo+or+pdf+to+an+interview.pdf",

  description: %{ <p>A growth hacker is a rare combination: 
    someone with the right marketing and technical skills who 
    can come up with clever marketing hacks and also track their results.</p>

            <p>In this talk, Mattan Griffel introduces you to the concept of 
            Growth Hacking and shares his favorite tips for getting started
             as a growth hacker.</p>
...
growth_hacking_monthly = Product.create(
    ...
    price: "4.99", sku:"GROHACK2", length: "6 months",
    author_image_name: "teacher-image.jpg",
    details: "We will charge you monthly for unlimited access to our mentoring team",
    download_url: "https://s3.amazonaws.com/axmc-one-month-stripe-payments/How+to+add+a+photo+or+pdf+to+an+interview.pdf",
  ...
  description: %{ <p>A growth hacker is a rare combination: 
    ...
    can come up with clever marketing hacks and also track their results.</p>
            ...
            <p>In this series, Mattan Griffel introduces you to the concept of 
            Growth Hacking and shares his favorite tips for getting started
             as a growth hacker.</p>
